...
\input{latex_einstellungen/v_expose}
...
\begin{document}	
	...
	% einzelne Kapitel
	\input{expose/1_fragestellung}	
	\input{expose/2_zielsetzung}
	\input{expose/3_grundlage}
	\input{expose/4_konzept}
	\input{expose/5_gliederung}
	\input{expose/6_motivation}
